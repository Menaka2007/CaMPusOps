...
def init_db():
    ...
    students_data = [
        ("717721L101", "J. Samhitha", "CSE", 3, "samhitha.j@sece.ac.in", "student"),
        ("717721L102", "S. Chandrika", "ECE", 3, "chandrika.s@sece.ac.in", "student"),
        ("717721L103", "Menaka S", "IT", 4, "menaka.s@sece.ac.in", "student"),
        ("717721L104", "Vinisha", "CSE", 3, "vinisha@sece.ac.in", "student"),
        ("717721L105", "Anushya", "CSE", 3, "anushya@sece.ac.in", "student"),
        ("717721L106", "Varsha", "CSE", 3, "varsha@sece.ac.in", "student"),
        ("717721L107", "Kanishka", "CSE", 3, "kanishka@sece.ac.in", "student"),
        ("717721L108", "Prega", "CSE", 3, "prega@sece.ac.in", "student"),
        ("717721L109", "Akshaya", "CSE", 3, "akshaya@sece.ac.in", "student"),
        ("717721L110", "Madhumita", "CSE", 3, "madhumita@sece.ac.in", "student"),
    ...
    # 2. Faculty
    faculty_data = [
        ("Dr. Ramakrishnan", "CSE", "Professor & Head", "ramakrishnan.cse@sece.ac.in", "A-Block 302"),
